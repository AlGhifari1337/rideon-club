    ...
    <header class="header">
        <div class="container">
            <div class="header-logo">
                <a href="#" class="logo"><img src="docs/assets/images/logo1.png"></a> RideOn Adventure
            </div>
...
<footer>
    ...
    <div class="footer">
        <div class="footer-logo"><a href="#" class="logo"><img src="docs/assets/images/logo1.png" alt="WWalk Logo"></a> RideOn Adventure</div>
    </div>
</footer>
</body>
